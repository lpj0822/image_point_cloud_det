...
class PointCloudClassifyConfig(PointCloudTaskConfig):

    def __init__(self):
        super().__init__()
        self.set_task_name(TaskName.PC_Classify_Task)
        # test
        self.test_resul_name = 'pc_cls_evaluation.txt'
        self.test_result_path = os.path.join(self.root_save_dir, self.test_resul_name)
        # train
        self.log_name = "pc_classify"
    ...
    def load_data_value(self, config_dict):
        if config_dict.get('number_point_features', None) is not None:
            self.number_point_features = int(config_dict['number_point_features'])

    def save_data_value(self, config_dict):
        config_dict['number_point_features'] = self.number_point_features
